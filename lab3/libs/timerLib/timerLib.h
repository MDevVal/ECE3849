...
public:
    ...
    /**
     * @brief Inicializa el timer en modo peri�dico down-counter.
    ...
    /** Detiene el timer (no afecta configuraci�n). */
    void stop();

    /** Reinicia el "origen" de tiempo (offset l�gico). */
    void reset();
    ...
    /** Indica si est� usando Wide Timer (64-bit). */
